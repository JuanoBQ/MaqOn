...
export function WhatsAppButton() {
  ...
  const message = 'Hola! Me interesa conocer más sobre sus productos y servicios de importación de maquinaria industrial.'
    ...
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {showTooltip && (
          ...
          >
            <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-w-md w-80">
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-sm font-semibold text-gray-900">MaqOn</span>
              </div>
              <p className="text-sm text-gray-700 leading-relaxed">
                ¡Hola! 👋 ¿Necesitas ayuda con importación de maquinaria industrial?
              </p>
